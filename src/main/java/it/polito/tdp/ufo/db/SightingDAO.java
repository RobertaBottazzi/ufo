...
public class SightingDAO {
	...
	public int countByShape(String shape) {
		try{
			...
			throw new RuntimeException("Database error in readShape",e); //ho catturato l'eccezione e non sapendo come gestirla lascio che lo faccia il programma a runtime
		}
